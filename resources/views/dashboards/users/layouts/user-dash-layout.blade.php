...
<div class="wrapper">
 ...
 <li class="nav-item">
            <a href="{{ route('user.order')}}" class="nav-link {{ (request()->is('order/user*')) ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('user.support')}}" class="nav-link {{ (request()->is('user/support*')) ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('user.payment')}}" class="nav-link {{ (request()->is('user/payment*')) ? 'active' : '' }}">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2022-2030 <a href="https://kimtechsoftwaresolutions.co.ke/">Kimtech Software Solutions</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
